...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/30 17:59:50 by mmaxime-          #+#    #+#             */
/*   Updated: 2022/03/31 11:50:14 by mmaxime-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	bresenham(t_position dots_line, t_fdf *data)
{
	...
	x_step /= max;
	y_step /= max;
	while ((int)(dots_line.x - dots_line.x1) ||
			(int)(dots_line.y - dots_line.y1))
	{
