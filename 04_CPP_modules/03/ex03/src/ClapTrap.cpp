...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/26 11:33:13 by mmaxime-          #+#    #+#             */
/*   Updated: 2023/01/26 11:33:13 by mmaxime-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage( unsigned int amount )
{
	...
	if ( amount > _hitPoints )
		...
		_hitPoints -= amount;
	std::cout << "HP left for " << _name << ": " << _hitPoints << std::endl;
	return ;
}
...
void	ClapTrap::beRepaired( unsigned int amount )
{
	...
	_hitPoints += amount;
	_energyPoints--;
	std::cout << "HP for " << _name << " are now: " << _hitPoints << std::endl;
	std::cout << "EP left for " << _name << ": " << _energyPoints << std::endl;
}
